...
function titleCase(title) {
  ...
  for (let i = 0; i < wordArr.length; i++) {
    if (wordArr[i] === 'javascript' && wordArr[i + 1] !== ':') {
      wordArr[i] = 'JavaScript';
      titleCaseStr += wordArr[i] + ' ';
    } else if (wordArr[i] === 'javascript' && wordArr[i + 1] === ':') {
      wordArr[i] = 'JavaScript';
      titleCaseStr += wordArr[i];
      ...
      titleCaseStr += wordArr[i][0].toUpperCase() + wordArr[i].slice(1) + ' ';
    } else if (wordArr[i + 1] === ':') {
      titleCaseStr += wordArr[i][0].toUpperCase() + wordArr[i].slice(1);
    } else if (wordArr[i - 1] === ':') {
      titleCaseStr += wordArr[i][0].toUpperCase() + wordArr[i].slice(1) + ' ';
